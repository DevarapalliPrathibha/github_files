...
'''
#import pandas as pd
def_txt=pd.read_csv("C:/Users/user718/PycharmProjects/pythonProject/pokemon/pokemon_data (1).csv")
print(def_txt)
print("************")
print(df.iloc[2,5])
print("************")

df_xlsx = pd.read_excel("C:/Users/user718/PycharmProjects/pythonProject/pokemon/pokemon_data (1).xlsx")
